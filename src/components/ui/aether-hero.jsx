...
/** Default fragment shader — polar aurora pattern */
...
export default function AetherHero({
  ...
  }, [fragmentSource, dprMax]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    >
      ...
      {/* Content — either children (custom) or default title/cta layout */}
      {children ? (
